...
<a href="index.php">Home</a>
    ...
    <div id = "home1">
        <div id = "pic11">
            <img src = "rentimage5.webp">
        </div>
       <div id = "pic">
        <div class  = "pics">
            <img src = "rentint3.jpg">
           </div>
           
           <div class  = "pics1">
            <img src = "rentint4.jpeg">
           </div>
    
       </div>
    
    </div>
    <div class="head">Civil Lines</div>  
 ...
 Showroom For Rent
       ...
       <div id = "info2">
        ...
        <a href = "https://www.google.com/maps/search/civil+lines+mumbai/@18.964891,72.8213094,16z?entry=ttu">  <div id = "map" >
            <img src = "rentmap5.png">
        </div></a><br><br>
        <br><br><br><br>
        <div class  = "formm">
