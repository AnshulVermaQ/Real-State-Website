...
<link href="https://fonts.googleapis.com/css2?family=Martian+Mono:wght@800&family=Montserrat:wght@800&family=Oswald:wght@700&display=swap" rel="stylesheet">
    ...
    <style>
       ...
       #content-Con1{
        ...
        width:100%;
        display: flex;
        background-color: rgb(48, 118, 118);
       }
       #content-Con2{
        height:60vh;
        width:100%;
...
<body>
    ...
    <br><br>
    <div id = "legal-Con">
        <img src = "escrow12.png" height="100%" width="100%">
    </div>
    
    <div id = "content-Con">
        <img src = "escrow2.png" height="100%" width="100%">
    </div>
    <div id = "content-Con1">
        <img src = "escrow3.png" height="100%" width="100%">
    </div><br><br><br>
    <div id = "content-Con2">
       <img src  ="escrow4.png" height="100%" width="100%">
    </div><br>
    <div id = "content-Con3">
        <img src  ="escrow5.png" height="100%" width="100%">
    </div><br>
    <div id = "content-Con4">
       <img src="escrow6.png" height="100%" width="100%">
    </div><br><br><br><br><br><br>
    <div id = "content-Con5">
        <img src="escrow7.png" height="100%" width="100%">
     </div><br><br><br><br><br>
     <div id = "content-Con6">
        <img src="escorw8.png" height="100%" width="100%">
     </div>
    <br><br><br><br>
<div id = "footer">
    <div class = "f1">
